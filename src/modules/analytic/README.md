...
**Analytic Accounts** — Project / department / business-unit tagging.

Status: not yet implemented. Delivered in **Phase 3** (see [TODO.md](../../../TODO.md)).

## Scope

- CRUD over `AnalyticAccount` (INCOME / EXPENSE), soft archive.
- Tagged on document lines and carried onto journal items.
- The dimension budgets are measured against.
...
| `analytic-service.ts` | Business rules. Takes a `DbClient`, throws domain errors.           |
